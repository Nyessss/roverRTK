...
```
   ...
   / __ \____ _   _____  _____   / __ \/_  __/ //_/
  / /_/ / __ \ | / / _ \/ ___/  / /_/ / / / / ,<   
 / _, _/ /_/ / |/ /  __/ /     / _, _/ / / / /| |  
...
```
## Components
ESP32S3 [t-display-s3](https://github.com/Xinyuan-LilyGO/T-Display-S3/blob/main/image/T-DISPLAY-S3-TOUCH.png) ST7789 170x320 x DP0601 RTK GNSS (F9P) in a [3d-printed case]
